...
const { WIDTH, HEIGHT, ENEMIES_COUNT, PALMS_COUNT, TREASURES_COUNT, LIVES, RETRY_PLAY_TIMEOUT_MS } = config;
...
function create() {
  ...
  scoreText = this.add.text(16, 16, 'Score: 0 / 10', { fontSize: '16px', fill: '#000', backgroundColor: '#fff' });
